...
std::string subconverter(RESPONSE_CALLBACK_ARGS)
{
    ...
    tribool argAppendType = getUrlArg(argument, "append_type"), argTFO = getUrlArg(argument, "tfo"), argUDP = getUrlArg(argument, "udp"), argUOT = getUrlArg(argument, "uot"), argGenNodeList = getUrlArg(argument, "list");
...
//    }
    ...
    ext.uot = (argTarget == "clash") && argUOT.get(false);
